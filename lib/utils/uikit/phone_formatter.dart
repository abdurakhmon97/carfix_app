...
class PhoneFormatter extends TextInputFormatter {
  ...
  void _init() {
    countryFullCode = _mask.startsWith('+') ? '+ $_countryCode' : ' $_countryCode';
    final cleanedMask = _mask.replaceAll(nonDigitsRegex, '');
    phoneFullLength = cleanedMask.length;
    phoneShortLength = cleanedMask.length - _countryCode.length;
  }
  ...
  TextEditingValue _formatPhone(
    ...
    if (cleanedText.startsWith(_countryCode) &&
